...
function NavigationBar() {
    return (
        <div>
            <div style={{height: '8vh', width: '100%', display: 'flex', alignItems: 'center', padding: '5px 15px 0 0', backgroundColor: 'gray', fontFamily: 'Space Mono, monospace'}}>
                <h1 style={{margin: '0 13% 0 25px', fontSize: '50px', padding: '0 60px 10px 0'}}>EmotionGPT</h1>
